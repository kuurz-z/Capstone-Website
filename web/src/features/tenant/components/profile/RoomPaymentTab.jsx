...
const RoomPaymentTab = ({
 ...
 {!activeReservation.paymentVerified && (
 <button
 className="w-full py-3 text-sm font-medium rounded-lg text-primary-foreground transition-colors"
 style={{ backgroundColor: "#FF8C42" }}
 >
 Pay Deposit - ₱
 {(activeReservation.totalAmount || 0).toLocaleString()}
 ...
 <button
 className="px-6 py-3 rounded-lg font-medium text-primary-foreground"
 style={{ backgroundColor: "#FF8C42" }}
 >
