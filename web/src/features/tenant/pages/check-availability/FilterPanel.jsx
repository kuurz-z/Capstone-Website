...
const FilterPanel = ({
 ...
 <label className="block text-base font-semibold text-foreground mb-6">
 Price Range
 </label>
 <ElasticSlider
 ...
 isStepped={true}
 stepSize={100}
 leftIcon={<Minus className="w-5 h-5 text-muted-foreground" />}
 rightIcon={<Plus className="w-5 h-5 text-muted-foreground" />}
 ...
 <button
 onClick={onClearAll}
 className="px-6 py-2 rounded-lg border border-border bg-card text-card-foreground hover:bg-muted"
 >
 Clear All
 </button>
 <button
 onClick={onClose}
 className="px-6 py-2 rounded-lg text-primary-foreground"
