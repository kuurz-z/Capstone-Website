...
function RoomAvailabilityPage() {
 ...
 case 'partial':
 return { dot: 'bg-amber-500', label: 'Partially Occupied', color: 'text-warning-dark' };
 case 'full':
 ...
 className="w-full pl-9 pr-4 py-2 bg-muted border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-ring/20 placeholder:text-muted-foreground/70"
 />
 </div>
 ...
 className="px-4 py-2 bg-[#D4AF37] hover:bg-[#C5A030] text-foreground rounded-lg font-medium transition-colors flex items-center gap-2 text-sm"
 >
 ...
 className={`group relative bg-card dark:bg-card border border-border/80 rounded-xl p-4 hover:border-primary/50 hover:shadow-md transition-all duration-200 text-center flex flex-col items-center justify-center w-[118px] h-[116px] ${!can("manageRooms") ? 'cursor-default' : 'cursor-pointer'}`}
 ...
 <span className="text-[18px] font-bold text-foreground dark:text-foreground tracking-tight leading-none mb-1.5">{room.roomNumber}</span>
