...
function OccupancyTrackingPage({ isEmbedded = false }) {
 ...
 className="px-3 py-2 bg-card border border-border rounded-md text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring/20"
 >
 ...
 <div className="p-3 rounded-lg bg-muted border border-border/70">
 ...
 className="border-b border-border hover:bg-muted/80 transition-colors cursor-pointer"
