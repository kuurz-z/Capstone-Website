    ...
    <section className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        <select
          ...
          className="px-3 py-2 bg-card border border-border rounded-md text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20"
        >
      ...
      >
        <div className="space-y-3 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="p-3 rounded-lg bg-gray-50 border border-gray-200/70">
                ...
                paginatedRooms.map((room) => {
                  ...
                  return (
                    <tr
                      ...
                      className="border-b border-border hover:bg-gray-100/80 transition-colors cursor-pointer"
            ...
            <div className="flex items-center justify-between mt-4 pt-3 border-t border-border">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3 py-1.5 text-xs border border-border rounded-md text-foreground hover:bg-muted disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Previous
                </button>
                <span className="text-xs text-muted-foreground">
