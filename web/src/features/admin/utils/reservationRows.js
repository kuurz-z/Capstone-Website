...
export function mapReservationAdminRow(reservation) {
  ...
  return {
    ...
    idValidationStatus: reservation.idValidationStatus || "not_validated",
    idMismatchFlag: reservation.idMismatchFlag || false,
    idNameMatchScore: reservation.idNameMatchScore || 0,
    idValidatedAt: reservation.idValidatedAt || null,
