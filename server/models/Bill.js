...
const billSchema = new mongoose.Schema(
  {
    ...
    transferSettlementKey: { type: String },
    transferSupplementOf: { type: mongoose.Schema.Types.ObjectId, ref: 'Bill' },
...
billSchema.index({ transferSettlementKey: 1 }, { unique: true, sparse: true });
