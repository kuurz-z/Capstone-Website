import { reconcileTenancyLifecycles } from "../services/tenancyLifecycleReconciliationService.js";
/**
 * ============================================================================
...
// ─── Job 19: Missing Contract Generation Reconciliation (every five minutes) ────
//
...
export function startScheduler(options = {}) {
  ...
  // Job 18: Renewal activation runs every minute across the Manila date boundary.
  ...
  // Job 19: Missing contracts and tenancy lifecycle reconciliation run every five minutes.
  // Retries contract preparation and replays missing deduplicated lifecycle events.
